      ...
      <div className="dash-grid">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div className="card">
            ...
            <div className="yield-bar-wrap">
              <div className="flex-between"><span style={{ fontSize: '13px', fontWeight: 500 }}>Master DSA in 60 days</span><span style={{ fontSize: '12px', color: 'var(--text2)' }}>₹5,000</span></div>
              <div className="yield-bar-track"><div className="yield-bar-fill" style={{ width: '47%' }}></div></div>
              <div className="flex-between" style={{ marginTop: '4px' }}><span style={{ fontSize: '11px', color: 'var(--text3)' }}>47% through lock period</span><span style={{ fontSize: '11px', color: 'var(--green)' }}>+₹48 yield</span></div>
            </div>
            <div className="yield-bar-wrap">
              <div className="flex-between"><span style={{ fontSize: '13px', fontWeight: 500 }}>Run 5K under 25 min</span><span style={{ fontSize: '12px', color: 'var(--text2)' }}>₹3,000</span></div>
              ...
              <div className="flex-between" style={{ marginTop: '4px' }}><span style={{ fontSize: '11px', color: 'var(--text3)' }}>47% through lock period</span><span style={{ fontSize: '11px', color: 'var(--green)' }}>+₹29 yield</span></div>
            </div>
            <div className="yield-bar-wrap">
              <div className="flex-between"><span style={{ fontSize: '13px', fontWeight: 500 }}>Ship GoalForge MVP</span><span style={{ fontSize: '12px', color: 'var(--text2)' }}>₹15,000</span></div>
              <div className="yield-bar-track"><div className="yield-bar-fill" style={{ width: '16%' }}></div></div>
              <div className="flex-between" style={{ marginTop: '4px' }}><span style={{ fontSize: '11px', color: 'var(--text3)' }}>16% through lock period</span><span style={{ fontSize: '11px', color: 'var(--green)' }}>+₹107 yield</span></div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="card" style={{ background: 'var(--amberDim2)', borderColor: 'rgba(245,166,35,.15)' }}>
            ...
            <p style={{ fontSize: '12px', color: 'var(--text2)', lineHeight: 1.6 }}>Using a buffer day extends the lock period by 1 day. This means more yield earned — it's a feature, not a punishment. You currently have 2 buffer days remaining.</p>
